 ...
 if ((isset($_POST["agregar"]))&&($_POST["agregar"]=="formu"))
    {
        ...
        $validar="SELECT * FROM estado WHERE id_estado='$id' or estados='$estado'";
        ...
        {
            $insertsql=$conectar->prepare("INSERT INTO estado(id_estado,estados) VALUES (?,?);");
            $insertsql->execute([$id,$estado]);
			...
			<div class="row">
				<div class="col-sm-4">
					<form id="frmArticulos"  name="formu" method="post" >
						...
						<input type="number" oninput="maxlengthNumber(this)" maxlength="3" class="form-control input-sm" id="id" name="ide">
						<label>Estados</label>
						<input type="text" oninput="multipletext(this)" maxlength="15" class="form-control input-sm" id="estado" name="estado">
						<br>
				...
				<div class="col-sm-8">
                    ...
                    <?php require_once "tabla_estado.php";?>
                    </div>
				</div>
			</div>
		</div>
