 ...
 if ((isset($_POST["agregar"]))&&($_POST["agregar"]=="formu"))
    {
        ...
        $validar="SELECT * FROM aseguradora WHERE id_aseguradora='$id' or aseguradora='$aseguradora'";
        ...
        {
            $insertsql=$conectar->prepare("INSERT INTO aseguradora(id_aseguradora,aseguradora) VALUES (?,?);");
            $insertsql->execute([$id,$aseguradora]);
			...
			<div class="row">
				<div class="col-sm-4">
					<form id="frmArticulos"  name="formu" method="post" >
						...
						<input type="text" oninput="multipletext(this)" maxlength="15" class="form-control input-sm" id="marca" name="aseguradora">
						<br>
				...
				<div class="col-sm-8">
                    ...
                    <?php require_once "tabla_aseguradora.php"?>
                    </div>
				</div>
			</div>
		</div>
