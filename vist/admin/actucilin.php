...
<?php
        ...
        $consulta=$conectar->prepare("SELECT * from cilindraje where id_cilindraje='".$_GET['actu']."' ");
        $consulta->execute();
       ...
       if ((isset($_POST["actualizar"]))&&($_POST["actualizar"]=="form"))
       {
        ...
        {
          $actusql=$conectar->prepare("UPDATE cilindraje SET cilindraje ='$nombre' WHERE id_cilindraje='".$_GET['actu']."'");
          $actusql->execute();
			...
			<div class="row">
				<div class="col-sm-4">
					<form id="frmArticulos"  name="formu" method="post" >
						...
						<input type="text" class="form-control input-sm" id="nombre" name="nombreu"  value="<?php echo $query['cilindraje'] ?>">
